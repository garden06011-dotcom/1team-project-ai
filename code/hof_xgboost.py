...
# 1. 엑셀 불러오기
# ---------------------------------------------------------
df = pd.read_excel("y추가완료_호프 데이터칼럼.xlsx")   # 파일명 변경!
...
# 8. 엑셀로 저장
# ---------------------------------------------------------
dong_scores.to_excel("hof_XGBoost.xlsx")
print("\n파일 저장 완료: hof_XGBoost.xlsx")
...
# 10. 모델 저장 (.pkl)
# ---------------------------------------------------------
joblib.dump(model, "hof_XGBoost.pkl")
print("\nXGBoost 모델 저장 완료: hof_XGBoost.pkl")
